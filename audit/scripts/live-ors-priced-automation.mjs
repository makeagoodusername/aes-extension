...
const maxPerDay = numberEnv("AES_PRICE_MAX_PER_DAY", 25)
const maxPerHour = numberEnv("AES_PRICE_MAX_PER_HOUR", 10)
...
function liveAutomationExpression(input) {
    return `(${async function run(input) {
        ...
        const maxPerDay = input.maxPerDay
        const maxPerHour = input.maxPerHour
        const required = [
            "AesRoutePriceAutomator",
            "RouteAssistantRouteSync",
            "RouteAssistantOrsScraper",
