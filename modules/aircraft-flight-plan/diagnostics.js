...
;(function () {
    ...
    const SELECTORS = [
        ...
        {scope: "form", purpose: "Flight-number input",
         selector: "input[name='number:number_body:input']",
         note: "1–4 numeric chars; AS auto-assigns when blank on submit"},
        {scope: "form", purpose: "Find first available anchor",
         selector: "a[href*='number~find~first']",
         note: "Wicket Ajax — populates the flight-number input subtree"},
